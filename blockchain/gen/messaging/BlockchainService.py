...
class Client(Iface):
  ...
  def send_unregister_node(self, pass_phrase):
    self._oprot.writeMessageBegin('unregister_node', TMessageType.CALL, self._seqid)
...
class Processor(Iface, TProcessor):
  ...
  def process_phase_1_message(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("phase_1_message", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_phase_2_message(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("phase_2_message", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_phase_3_message(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("phase_3_message", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_phase_4_message(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("phase_4_message", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_phase_5_message(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("phase_5_message", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_receipt_request(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("receipt_request", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_transfer_data(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("transfer_data", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_subscription_provisioning(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("subscription_provisioning", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_subscription_request(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("subscription_request", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
