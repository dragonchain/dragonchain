...
class TestSignVerificationRecord(TestCase):
    def test_sign_verification_record(self):
        ...
        expected_output = {'phase': 1, 'verification_record': {'verification_info': '', 'verification_ts': 1479266547,
                                                               'block_id': 9404771, 'lower_phase_hash': 0,
                                                               'origin_id': '31ce807a-868c-11e6-99f6-3c970e3bee11',
                                                               'signature': {
                                                                   'signatory': '31ce807a-868c-11e6-99f6-3c970e3bee11',
                                                                   ...
                                                                   'public_key': '-----BEGIN PUBLIC KEY-----\nME4wEAYHKoZIzj0CAQYFK4EEACEDOgAE7pcbDVgIxjjvYS4Ce+cR54vH+mgb5OvK\nwNQfh4iH8GyLjM0LpbZuuKh090/D7jONd+xeKuS9t8A=\n-----END PUBLIC KEY-----',
                                                                   'signature_ts': 1479266547,
                                                                   'signature': 'DFuKdobLwr53cg2shQtiGw+W7mK6ikAJ8TtAOj78nFUcIbW3TEIn9spiXRH1fDJehGRTfPBCjjs=\n'},
                                                               'phase': 1,
                                                               'prior_hash': 'c26a38fefb2140ac36163b79c31050eaa4021d44fa121e521a43e0283b3fba3cb6f723d57cb9ae4108603942ad38d4ebfd2a0325f6c19e580627e063188a1624'},
                           'block_id': 9404771}
        testoutput = crypto.sign_verification_record(signatory, prior_block_hash, lower_phase_hash, public_key,
                                                     private_key, block_id, phase, origin_id, verification_ts,
                                                     verification_info)
        self.assertEqual(expected_output['verification_record']['signature']['hash'],
                         testoutput['verification_record']['signature']['hash'])
        ...
        expected_output = {'phase': 1, 'verification_record': {'verification_info': '', 'verification_ts': 1479266547,
                                                               ...
                                                               'signature': {
                                                                   ...
                                                                   'public_key': '-----BEGIN PUBLIC KEY-----\nME4wEAYHKoZIzj0CAQYFK4EEACEDOgAE7pcbDV'
                                                                                 ...
                                                                                 'D7jONd+xeKuS9t8A=\n-----END PUBLIC KEY-----',
                                                                   'signature_ts': 1479266547,
                                                                   'signature': 'DFuKdobLwr53cg2shQtiGw+W7mK6ikAJ8TtAOj78'
                                                                                'nFUcIbW3TEIn9spiXRH1fDJehGRTfPBCjjs=\n'},
                                                               'phase': 1,
                                                               'prior_hash': 'c26a38fefb2140ac36163b79c31050eaa4021d44fa121e521a43e0283b3fba3cb6f72'
                                                                             '3d57cb9ae4108603942ad38d4ebfd2a0325f6c19e580627e063188a1624'},
                           'block_id': 9404771}

        test_output = crypto.sign_verification_record(signatory, prior_block_hash, lower_phase_hash, public_key,
                                                      private_key, block_id, phase, origin_id, verification_ts,
                                                      verification_info)
        self.assertEqual(expected_output['verification_record']['signature']['hash'],
                         test_output['verification_record']['signature']['hash'])
...
class TestSignTransaction(TestCase):
    def test_sign_transaction(self):
        ...
        self.assertRaises(KeyError, crypto.sign_transaction, signatory, private_key_string, public_key_string,
                          test_transaction)
