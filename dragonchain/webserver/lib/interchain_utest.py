...
class TestInterchain(unittest.TestCase):
    ...
    @patch("dragonchain.webserver.lib.interchain._get_output_dto_v1", return_value="blah")
    def test_create_interchain_bitcoin(self, mock_get_output, mock_save_client, mock_new_from_user):
    ...
    @patch("dragonchain.lib.dao.interchain_dao.save_interchain_client")
    @patch("dragonchain.webserver.lib.interchain._get_output_dto_v1", return_value="blah")
    def test_create_interchain_ethereum(self, mock_get_output, mock_save_client, mock_new_from_user):
