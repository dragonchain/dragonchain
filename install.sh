...
clear
sudo apt update
sudo apt-get install openssl thrift-compiler python-thrift uuid docker docker-compose python2.7 python-pip postgresql postgresql-server-dev-9.5 screen
export PYTHONPATH=./
sudo python setup.py install
sudo python setup.py gen_thrift
